  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-16">
      ...
      <p className="text-gray-600 mb-4">
        At ChankuGlobal Ltd., we are here to help you. If you have any questions
        or need assistance, please refer to our Help Center or FAQs below.
      </p>

      <h2 className="text-2xl font-bold mt-6">Help Center</h2>
      <p className="text-gray-600 mb-4">
        For any inquiries or support requests, please contact us at
        info@chankuglobal.co.ke or call us at +254 724 539 053.
      </p>
